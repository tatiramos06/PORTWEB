...
<head>
  ...
  <style>
    :root {
      /* Palette: Executive Slate Gray & Rose Gold Quartz */
      --bg-dark: #0c0e14;
      --bg-card: rgba(22, 27, 38, 0.88);
      --bg-card-hover: rgba(30, 38, 54, 0.98);
      --bg-nav: rgba(12, 14, 20, 0.95);
      
      --primary: #ec4899;
      --primary-rose: #f472b6;
      --primary-glow: rgba(244, 114, 182, 0.35);
      --electric: #c084fc;
      --electric-glow: rgba(192, 132, 252, 0.28);
      ...
      --border-active: rgba(244, 114, 182, 0.55);
      --radius-sm: 8px;
      --radius-md: 16px;
      --radius-lg: 24px;
      --radius-full: 9999px;
      ...
      --shadow-glow: 0 0 35px rgba(244, 114, 182, 0.25);
    ...
    *, *::before, *::after {
    ...
    .gradient-text {
      background: linear-gradient(135deg, #ffffff 0%, var(--primary-rose) 45%, var(--electric) 100%);
    ...
    .nav-links a::after {
      ...
      width: 0%;
      height: 2px;
      background: linear-gradient(90deg, var(--primary-rose), var(--electric));
      transition: var(--transition);
      border-radius: 2px;
    }
    ...
    .hero-wrapper {
      position: relative;
      background: 
        linear-gradient(180deg, rgba(12, 14, 20, 0.6) 0%, rgba(12, 14, 20, 0.95) 100%),
        radial-gradient(circle at 50% 20%, rgba(244, 114, 182, 0.18), transparent 60%);
    ...
    .portrait-card {
      width: 100%;
      border-radius: var(--radius-lg);
      background: linear-gradient(145deg, #1e2432, #0f131c);
      border: 1px solid var(--border);
      padding: 16px;
    ...
    .brand-badge-overlay {
      ...
      bottom: -20px;
      right: -20px;
      background: linear-gradient(135deg, #1e2432, #0d1017);
    ...
    .project-card.featured {
      ...
      background: linear-gradient(145deg, rgba(22, 27, 38, 0.92), rgba(36, 44, 62, 0.95));
  ...
  <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='%230c0e14'/><text x='50' y='68' font-family='sans-serif' font-weight='900' font-size='50' fill='%23f472b6' text-anchor='middle'>TR</text></svg>" />
</head>
<body>
  ...
  <header>
    <div class="container navbar">
      <a href="#" class="brand" aria-label="Ir para o topo">
        ...
        <span>Tatiana <span style="color: var(--primary-rose);">Ramos</span></span>
      </a>
  ...
  <main>
      ...
      <div class="container">
        ...
        <div class="projects-grid">
          ...
          <div class="glass-panel project-card featured">
            ...
            <div style="background: rgba(244, 114, 182, 0.06); border: 1px solid rgba(244, 114, 182, 0.25); border-radius: var(--radius-md); padding: 28px; text-align: center;">
    ...
    <section id="aura">
      <div class="container">
        <div class="glass-panel" style="padding: 60px; background: linear-gradient(135deg, rgba(22, 27, 38, 0.95), rgba(46, 32, 54, 0.85)); border-color: rgba(244, 114, 182, 0.4);">
...
Write-Host "Generated Executive Feminine Slate Gray & Rose Gold index.html!"
