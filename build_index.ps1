...
<head>
  ...
  <style>
    :root {
      ...
      --primary: #3892ff;
      --primary-glow: rgba(56, 146, 255, 0.35);
      --electric: #00f0ff;
      --electric-glow: rgba(0, 240, 255, 0.25);
      ...
      --border-active: rgba(56, 146, 255, 0.4);
      --radius-sm: 8px;
      --radius-md: 16px;
      --radius-lg: 24px;
      --radius-full: 9999px;
      ...
      --shadow-glow: 0 0 35px rgba(56, 146, 255, 0.2);
    ...
    *, *::before, *::after {
    ...
    .eyebrow {
      ...
      border: 1px solid rgba(56, 146, 255, 0.25);
      padding: 6px 16px;
...
<body>
  ...
  <!-- Navigation Header WITH EXPERIÊNCIA CLEARLY VISIBLE -->
  <header>
  ...
  <main>
    ...
    <!-- EXPERIÊNCIA PROFISSIONAL COMPLETA DO LINKEDIN (DIRECT NAV TARGET) -->
        ...
        <div class="timeline-container">
          ...
          <div class="glass-panel timeline-card">
            <div class="timeline-header">
              <div>
                <span class="company-name">Superlógica Tecnologias • 4 anos 9 meses no grupo</span>
            ...
            <p style="color: var(--text-main); font-size: 0.98rem; margin-bottom: 12px;">
              Atuação na condução de projetos de transformação digital, desenvolvimento de soluções e automação de processos com foco em otimização operacional e evolução dos produtos da companhia.
            </p>

            <ul class="timeline-bullets">
              <li>Implantação e homologação de novos Nexus Apps.</li>
              <li>Desenvolvimento de aplicações voltadas para automação e ganho de produtividade.</li>
              <li>Utilização de Inteligência Artificial Generativa para aceleração do desenvolvimento de soluções e automação de atividades.</li>
              <li>Engenharia de prompts e construção de fluxos utilizando ferramentas de IA como <strong>Cursor AI</strong>.</li>
              <li>Desenvolvimento de scripts e aplicações em <strong>Python</strong> para processamento de dados, integrações e automações.</li>
              <li>Planejamento, execução, análise, transformação e validação de migração de grandes volumes de dados entre sistemas para garantir consistência e integridade das informações migradas.</li>
              <li>Levantamento de requisitos junto às áreas de negócio e clientes.</li>
              <li>Gestão simultânea de múltiplos projetos utilizando metodologias ágeis, híbridas e tradicionais.</li>
              <li>Atuação junto às equipes de Produto, Desenvolvimento, Implantação e Customer Success para entrega de soluções escaláveis.</li>
            </ul>
          </div>
          ...
          <div class="glass-panel timeline-card">
            ...
            <ul class="timeline-bullets">
              <li>Acompanhamento de projetos de implantação de software e treinamento sobre as rotinas do sistema (remoto e presencial).</li>
              <li>Ponto de contato técnico com clientes durante todo o processo de implantação.</li>
              <li>Validação de integrações entre sistemas, identificação de bugs e atuação acionando o time de desenvolvimento.</li>
              <li>Suporte a usuários, realização de treinamentos, geração e atualização de documentação de integrações, validação de prazos e ajuste de cronogramas.</li>
            </ul>
          </div>
          ...
          <div class="glass-panel timeline-card">
            ...
            <ul class="timeline-bullets">
              <li>Acompanhamento de projetos de implantação do ERP Ahreas, treinamento sobre rotinas do sistema (remoto e presencial).</li>
              <li>Ponto técnico de contato com clientes, validação de integrações e identificação de melhorias em sistemas.</li>
            </ul>
          </div>

          <!-- 04. Síndico Profissional -->
          <div class="glass-panel timeline-card">
            <div class="timeline-header">
              <div>
                <span class="company-name">Gestão Operacional & Condominial</span>
                <h3 class="role-title">Síndica Profissional</h3>
              </div>
              <span class="date-badge">Janeiro de 2015 - Agosto de 2022 (7 anos 8 meses)</span>
            </div>

            <ul class="timeline-bullets">
              <li>Gestão participativa com prestação de contas transparente, clara e objetiva.</li>
              <li>Estratégias para redução de custos, controle de segurança, organização e liderança de colaboradores.</li>
              <li>Elaboração, desenvolvimento e implementação de programas de capacitação e ações de fidelização.</li>
            </ul>
          </div>
          ...
          <div class="glass-panel timeline-card">
            <div class="timeline-header">
              <div>
                ...
                <h3 class="role-title">Gerente de Condomínios</h3>
              </div>
              <span class="date-badge">Maio de 2018 - Julho de 2020 (2 anos 3 meses)</span>
            </div>
            <p style="color: var(--text-muted); font-size: 0.95rem;">Gestão de operações condominiais, atendimento e liderança de processos de implantação.</p>
          </div>
          ...
          <div class="glass-panel timeline-card">
            <div class="timeline-header">
              <div>
                ...
                <h3 class="role-title">Gerente Predial & Assistência de Sindicância</h3>
              </div>
              <span class="date-badge">2017 - 2018</span>
            </div>
            <p style="color: var(--text-muted); font-size: 0.95rem;">Acompanhamento de rotinas prediais, gestão de manutenção, equipes e auditoria de processos.</p>
          </div>
      ...
      <div class="container">
        ...
        <div class="edu-grid">
          ...
          <div class="glass-panel edu-card">
            ...
            <div class="edu-item">
              <div class="edu-title">Início do Projeto: Gestão de Sucesso</div>
    ...
    <section id="contato">
      <div class="container">
        <div class="section-head center">
          <div class="eyebrow">Conexão</div>
          <h2>Vamos Conversar</h2>
          <p>Entre em contato diretamente pelos canais profissionais abaixo:</p>
        </div>
  ...
  <footer>
    <div class="container">
      <p>© 2026 Tatiana Ramos • Analista de Projetos Pleno na Superlógica Tecnologias | IA Generativa | Python | Automação | Migração de Dados</p>
    </div>
  </footer>
...
[System.IO.File]::WriteAllText("c:\Users\win\Documents\TATIANA\POTFOLIO\index.html", $html, [System.Text.Encoding]::UTF8)
Write-Host "Rebuilt index.html with highlighted Experiência menu item!"
